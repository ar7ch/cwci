...
unsigned long letters_counter = 0;
unsigned long number_counter = 0;
unsigned long digit_counter = 0;
unsigned long lines_counter = 0;
unsigned long max_word_length = 0;
